...
feature_num = 80
# 模型结构
pb_path = f'./resources/asr_model_aishell_pinyin/mrcldnn'

vocab = []
with open('./resources/pinyin.txt', 'r', encoding='utf-8') as f:
...
class SpeechDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #     sentence = f.readlines()[1]
        #     sentence = sentence.replace('\n', '').split()
        sentence = sentence.replace('\n', '').replace(' ', '')
        sentence = lazy_pinyin(sentence, style=Style.TONE3, neutral_tone_with_five=True)
...
def get_audio_len(audio_len, name):
...
def pre_data():
    ...
    train_paths = glob('F:/YYSB/code/code/data/data_aishell1/wav/train/*/*.wav')
    test_paths = glob('F:/YYSB/code/code/data/data_aishell1/wav/test/*/*.wav')
    train_dict = {}
    test_dict = {}
    ...
    with open('F:/YYSB/code/code/data1/asr/data_aishell1/transcript/aishell_transcript_v0.8.txt', 'r', encoding='utf-8') as fr:
